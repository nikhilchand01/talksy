...
import NoNotications from "../components/NoNotications.jsx";
          ...
          <>
            {incomingRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex itmes-center gap-2">
                    ...
                    <div className="card-body p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <img src={request.sender.profilePic || null} alt={request.sender.fullName} />
                          </div>
                          <div>
                          <h3 className="font-semibold">{request.sender.fullName}</h3>
                            {/* <div className="flex flex-wrap gap-1.6 mt-1">
