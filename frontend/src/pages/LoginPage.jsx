            ...
            <form onSubmit={handlelogin}>
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="form-control w-full space-y-2">
                    ...
                    <input type="email" placeholder="hello@gmail.com" className="input input-bordered w-full" value={loginData.email} onChange={(e) => setLoginData({ ...loginData, email: e.target.value })} required />
                  </div>
                  <div className="form-control w-full space-y-2">
                    <label className="label">
                  ...
                  <div className="fp text-right text-sm">
                  <Link to={'/forgotpassword'}>Forgot Your Password</Link></div>
             ...
             <div className="text-center mt-4">
                                    <p className="text-sm">Don't have an Account?{" "}
                                        <Link to="/signup" className="text-primary hover:underline">Sign Up
                                        </Link>
                                    </p>
                                </div>
                </div>
...
<div className="max-w-md p-8">
  <div className="relative aspect-square max-w-sm mx-auto">
    <img src="/logo1.png" alt="Language connction illustration" className="w-full h-full" />
  </div>
